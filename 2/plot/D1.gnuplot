...
plot '../data/data_1' u (-1*$1):2:3:4 every ::0::14 with xyerrorbars title 'Sperrrichtung' ls 1,\
        '../data/data_1' every ::15::22 with xyerrorbars title 'Durchlassrichtung' ls 2
